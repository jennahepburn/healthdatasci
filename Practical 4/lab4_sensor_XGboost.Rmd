...
When eyes open, we see a spike in the EEG intensities, especially when the eyes first open. 
...
Based on these analyses, it appears that electrodes are slightly more intense when eyes are open for T8 and F8, as medians are greater when eyes are open. 
