...
A potential drawback to data augmentation is that it may reduce the quality of images. I wonder if adding additional noise to the images would impact accuracy.
...
MobileNet is a class of convolutional neural network (CNN) that uses depthwise separable convolutions to reduce the number of parameters compared. This makes it much faster than other models that we have utilized.
