...
No, I do not think the general purpose of a lemmatizer will work well for medical data. This is because things can mean very different things in medicine, but sound the same. For example, hypertension and hypotension sound very similar, but are complete opposites in reality, making the distinction very important. Also, the context of what part of the body something is happening in is very important. For example, a blood clot in the brain is a stroke, and a blood clot in the heart is a heart attack. While these are both blood clots, they have completely different effects and outcomes, and require different specialists. Therefore these should not be grouped together for clinical purposes, despite being similar.
